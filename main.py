...
#logo
logo=PhotoImage(file="image/icon.png")
Label(root,image=logo, bg="#2f4155").place(x=10,y=0)

Label(root,text="Cyber Science", bg="#2d4155",fg="white",font="ariel 25 bold").place(x=100,y=20)

#first frame
frame = Frame(root,bd=3,bg="black",width=340,height=280,relief=GROOVE)
